...
require (
	...
	github.com/crossplane-contrib/xprin v0.2.0
...
replace github.com/crossplane-contrib/xprin => github.com/crossplane-contrib/xprin v0.2.1-0.20260509121724-b4294cc84e8b
